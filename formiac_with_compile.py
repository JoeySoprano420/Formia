...
# --- FORMIA Ecosystem Files ---

# setup_win.bat
# ----------------
# @echo off
# echo [SETUP] FORMIA Compiler Environment
# mkdir bin 2>nul
# mkdir out 2>nul
# python formia-prime.py main.fom --compile --emit nasm
...
# ----------------
# all:
# 	python3 formia-prime.py main.fom --compile --emit nasm
...
# 		- name: Run FORMIA Compiler
# 		  run: python3 formia-prime.py tests/test.fom --compile --emit nasm

# vscode-extension/package.json
# ----------------
# {
#   "name": "formia-lang",
#   "displayName": "FORMIA Language Support",
#   "description": "Syntax highlighting and language features for FORMIA",
#   "version": "0.1.0",
#   "publisher": "vaclabs",
#   "engines": {
#     "vscode": "^1.80.0"
...
#       {
#         "language": "formia",
#         "scopeName": "source.formia",
#         "path": "./syntaxes/formia.tmLanguage.json"
#       }
#     ]
#   }
# }
